...
const UserProfileMenu = ({ username }: { username?: string }) => (
  <button
    type="button"
    className="flex items-center gap-3 rounded-xl border border-transparent px-3 py-1.5 hover:bg-primary-700/5 transition"
  >
    <div className="flex flex-col items-center">
      ...
      <div className="mt-1 flex items-center gap-2">
        <span className="text-[10px] font-bold uppercase text-primary-900">
          LVL 15
        </span>
...
const AuthButtons = () => (
  <div className="flex items-center gap-3 pl-2">
    <Button href="/login" variant="white" className="h-11 py-2.5">
      Log In
    </Button>
    <Button href="/signup" variant="primary" className="h-11 py-2.5">
      Sign Up
    </Button>
  </div>
);
    ...
    <header className="flex h-14 items-center justify-between bg-primary-100 px-6">
      <div className="flex items-center gap-8">
        <a href="/" className="flex items-center justify-center">
          ...
          />
          <span className="font-sans text-2xl font-bold tracking-[-0.02em] text-primary-700">
            CodeBite
          </span>
        </a>
      ...
      <div className="flex items-center gap-4">
        <button
          ...
          className="flex h-10 w-10 items-center justify-center rounded-full p-2 text-neutral-700 transition hover:bg-primary-700/10"
        >
